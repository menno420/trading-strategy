...
- `any` · **Merging own / sibling green PRs is NOT walled** (corrects a prior false "self-merge classifier" entry): direct REST/MCP squash-on-green, arming auto-merge,…
